...
//    iBigInteger a("-3120967779187282561082512");
//    a.printEachNumber();
//    iBigInteger b("32352", 8); // 13546
//    b.printEachNumber();
//    iBigInteger c("4294967295");
//    iBigInteger d("4294967295");
//    d.printEachNumber();
//    iBigInteger e = c + d;
//    (-d).printEachNumber();
//    e.printEachNumber();
...
//    iBigInteger h = b - f;
//    h.printEachNumber();
//    iBigInteger i("1'00000000'00000000'00000000'00000000", 2);
//    iBigInteger j("111111'11111111'11111111'11111111", 2);
//    (i + j).printEachNumber();
//    (i - j).printEachNumber();
//
//    iBigInteger k("ffff", 16);
//    // iBigInteger l("ffff", 2);
//    k.printEachNumber();
//    // l.printEachNumber();
//
//    iBigInteger::from1MovingLeft(1).printEachNumber();
//    iBigInteger a{"2"};
//    iBigInteger b{"2000000000000000000000"};
//    (a - b).printEachNumber();
//    iBigInteger c{"229496729987886868698568326666666678"};
//    iBigInteger d{iBigInteger::from1MovingLeft(1)};
//    (b - c).printEachNumber();
//    iBigInteger a("798888888888888888888869");
//    std::cout << "toString(): " << a.toString();
//    iBigInteger b("8589934594", 10);
//    b.printEachNumber();
//    std::cout << "toString(): " << b.toString();
//    iBigInteger c("0");
//    iBigInteger b_c = b - c;
//    std::cout << b << " - " << c << " = " << b_c << std::endl;
//    iBigInteger c_b = c - b;
//    std::cout << c << " - " << b << " = " << c_b << std::endl;
//    iBigInteger d = b * b;
//    b.printEachNumber();
...
//
//    iBigInteger a("2");
//    iBigInteger b("124241144212125");
//    std::cout << a + b;
//
//    iBigInteger a{""};
//    a.printEachNumber();
//    std::cout << a << std::endl;
    //iBigInteger b{"1000000000000000000000000000000000000000"};
    //iBigInteger c = a + b;
    //std::cout << c << std::endl;
    //iBigInteger d = a * b;
    //std::cout << d << std::endl;
*/
    ...
    std::cout << iBigInteger{"-1"}.absoluteValue() << std::endl;
    std::cout << std::boolalpha << (iBigInteger{"1"} == iBigInteger{"1"}) << std::endl;

    std::cout << (iBigInteger{"4294967296"} >> 1) << std::endl;
